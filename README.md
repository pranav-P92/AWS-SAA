...
- helps you **send and receive emails from your applications or websites globally.**
- helps application to send mails like: Welcome mails, Notifications, password reset link, marketing emails, transactions emails.
...
| ----------------- | ------------------------------------- | ------------------------------------- |
| Main purpose      | Customer communication and marketing  | Application-to-application messaging  |
| Target users      | Customers/end users                   | Applications, services, systems       |
| Messages          | Email, SMS, push notifications, voice | SMS, email, push, HTTP, SQS, Lambda   |
| Use case          | Campaigns and user engagement         | Event notifications and system alerts |
| Pub/Sub model     | No (mainly campaigns)                 | Yes                                   |
...
---
### AWS Outposts (AWS Servies in your own data center)
